...
2) Describe your workflow for ingesting data sets?
    ...
    - This data is then entered into an Excel spreadsheet, fed through a series of scripts to automate gap-filling, and then generated into data products relevant to modeling studies.
